...
// const std::array<Direction, kNumActions>
//     kRotateRight{Direction::kNoop, Direction::kRight, Direction::kDown, Direction::kLeft, Direction::kUp};
const std::unordered_map<Direction, Direction> kRotateRight{
    ...
    {Direction::kNoop, Direction::kNoop},
};

// Rotate actions left
// const std::array<Direction, kNumActions>
//     kRotateLeft{Direction::kNoop, Direction::kLeft, Direction::kUp, Direction::kRight, Direction::kDown};
const std::unordered_map<Direction, Direction> kRotateLeft{
...
const std::unordered_map<Direction, std::pair<int, int>> kDirectionOffsets{
    {Direction::kUp, {0, -1}},
    {Direction::kUpLeft, {-1, -1}},
    {Direction::kLeft, {-1, 0}},
    {Direction::kDownLeft, {-1, 1}},
    {Direction::kDown, {0, 1}},
    {Direction::kDownRight, {1, 1}},
    {Direction::kRight, {1, 0}},
    {Direction::kUpRight, {1, -1}},
    {Direction::kNoop, {0, 0}},
};
...
// };
const std::unordered_map<Direction, Element> kDirectionToFirefly{
    {Direction::kUp, kElFireflyUp},
    {Direction::kLeft, kElFireflyLeft},
    {Direction::kDown, kElFireflyDown},
    {Direction::kRight, kElFireflyRight},
};
...
// };
const std::unordered_map<Direction, Element> kDirectionToButterfly{
    {Direction::kUp, kElButterflyUp},
    {Direction::kLeft, kElButterflyLeft},
    {Direction::kDown, kElButterflyDown},
    {Direction::kRight, kElButterflyRight},
};
