...
void Triangulation::set_neighbor(size_t neighbor_ind, size_t old_ind, size_t new_ind) {
...
bool Triangulation::flip_if_better(std::size_t t_ind, std::size_t e) {
    ...
    std::size_t s_ind = t.neighbors[e];
  ...
  cout << endl;
    ...
    std::size_t B = t.neighbors[(e + 1) % 3];
    std::size_t C = s.neighbors[(i + 2) % 3];
